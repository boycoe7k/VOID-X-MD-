...
module.exports = {
    ...
    async execute(sock, msg, args, extra) {
        try {
            ...
            const repoUrl = 'https://github.com/Boycoe-dev/VOID-X-MD';
            const apiUrl = 'https://api.github.com/repos/Boycoe-dev/VOID-X-MD';
            ...
            try {
                ...
                fallbackMessage += `🔗 *Repository:* VOID-X-MD\n`;
                fallbackMessage += `👨‍💻 *Owner:* Boycoe-dev\n`;
